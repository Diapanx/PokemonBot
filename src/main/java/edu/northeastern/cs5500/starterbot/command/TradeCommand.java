    ...
    public void onSlashCommandInteraction(@Nonnull SlashCommandInteractionEvent event)
        ...
        switch (event.getSubcommandName()) {
            ...
            case "view":
                ...
                for (TradeOffer openTrade :
                        tradeOfferController.getOpenTradesByTrainer(mentionedTrainer)) {
                    Pokemon pokemonForTrade =
                            pokemonController.getPokemonById(openTrade.getPokemonId());
                    avaliableTrades
                            .append(
                                    "     "
                                            + pokedexController
        ...
        if (buttonId.endsWith(":accept")) {
            ...
            String message =
                    String.format(
                            ...
                            trainerController
                                    .getTrainerForId(getRespondTrade().getTrainerId())
                                    .getDiscordUserId(),
